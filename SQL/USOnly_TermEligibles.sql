...
/*	Domestic -  T E R M  E L I G I B L E S			     */
/*                                                                   */
...
And     TGR.OPTS_GRNTD > isnull(tgr.CANCEL1_SHARES,0)
And	(substring(OPT.OPT_ID,1,1) not in ('f','c'))
And	Term.Term_ID In ('04','28','29')
And	left(opt.user_cd2,3) NOT IN ('067','203','520','672','787','676','21S','780')
And	opt.loc_cd <> 'estate'
